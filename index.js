import{a as $,i as q,S as x,N as O,P as T,A as B}from"./assets/vendor-t7rkesM2.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const u of o.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const v={openModalBtn:document.querySelector("[data-menu-open]"),closeModalBtn:document.querySelector("[data-menu-close]"),modal:document.querySelector("[data-menu]")};v.openModalBtn.addEventListener("click",b);v.closeModalBtn.addEventListener("click",b);document.querySelectorAll(".mobile-nav-item, .mob-btn-shop").forEach(e=>{e.addEventListener("click",b)});function b(){v.modal.classList.toggle("is-open")}const M=$.create({baseURL:"https://deserts-store.b.goit.study/api/",headers:{"Content-Type":"application/json"}}),m=async(e={})=>(await M.get("/desserts",{params:e})).data,A=async()=>(await M.get("/categories")).data,g=document.querySelector(".dessert-list-select"),S=document.querySelector(".dessert-categories-list"),k=document.querySelector(".loader"),f=document.querySelector(".dessert-list"),i=document.querySelector(".dessert-load-btn");let n=1;const l=8;let d="all";const y=document.querySelector(".dessert-select-wrapper");document.addEventListener("DOMContentLoaded",D);g.addEventListener("change",C);S.addEventListener("change",C);i.addEventListener("click",I);f.addEventListener("click",j);async function D(){L();try{const e=await A(),s=[{name:"Всі десерти",_id:"all"},...e];if(!s.length){c("Помилка завантаження");return}H(s),N(s);const t=await m({page:n,limit:l});if(!t.desserts.length){c("Помилка завантаження");return}w(t.desserts);const a=Math.ceil(t.totalItems/l);i.classList.remove("is-hidden"),n>=a?i.disabled=!0:i.disabled=!1}catch{c("Помилка завантаження")}finally{_()}}async function C(e){if(L(),E(),d=e.target.value,!d){c("Помилка завантаження");return}n=1,f.innerHTML="";try{const s={page:n,limit:l};d!=="all"&&(s.category=d);const t=await m(s);if(!t.desserts.length){c("Помилка завантаження");return}w(t.desserts);const a=Math.ceil(t.totalItems/l);i.classList.remove("is-hidden"),n>=a?i.disabled=!0:i.disabled=!1}catch{c("Помилка завантаження")}finally{_()}}async function I(){L(),i.disabled=!0,n+=1,E();try{const e={page:n,limit:l};d!=="all"&&(e.category=d);const s=await m(e);if(!s.desserts.length){c("Помилка завантаження");return}w(s.desserts);const a=document.querySelector(".dessert-list-item").getBoundingClientRect().height;window.scrollBy({top:a*1,behavior:"smooth"});const r=Math.ceil(s.totalItems/l);i.classList.remove("is-hidden"),n>=r?i.disabled=!0:i.disabled=!1}catch{c("Помилка завантаження")}finally{_()}}function j(e){const s=e.target.closest(".dessert-list-btn");if(!s)return;const t=s.closest(".dessert-list-item");if(!t)return;const a=t.dataset.id;openModal(a)}function H(e){const s=e.map(({name:t,_id:a})=>`
    <option value="${a}">${t}</option>`).join("");g.innerHTML=s}function N(e){const s=e.map(({name:t,_id:a})=>`
   <label for="${a}" class="dessert-category-label">
      ...
      `).join("");S.innerHTML=s}function w(e){const s=e.map(({name:t,_id:a,image:r,price:o,category:u,description:P})=>`
  <li class="dessert-list-item" data-id="${a}">
        <div class="dessert-list-wrapper">
          <img class="dessert-list-img" src="${r}" alt="${t}">
        </div>
  ...
  </div>`;z.insertAdjacentHTML("beforeend",R);new B(".accordion-container");
